...
export const desiredPrice = '30' // How many $ per transaction ( min 20, recomended min 40 )
export const desiredPriceBTC = '30' // How many $ per transaction ( min 20, recomended min 40 )
export const desiredPriceBNB = '30' // How many $ per transaction ( min 20, recomended min 40 )
export const minPriceDrop = 1.5
export const takeTrailingProfitFrom = 0.5
export const trailing = 0.05
